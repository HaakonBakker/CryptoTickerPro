...
class PageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newVc(viewController: "first"),
                ...
                self.newVc(viewController: "fifth"),
                self.newVc(viewController: "sixth"),]
    }()
    ...
    func newVc(viewController: String) -> UIViewController {
        return UIStoryboard(name: "OnboardingV1", bundle: nil).instantiateViewController(withIdentifier: viewController)
    }
